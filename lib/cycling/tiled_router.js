...
// PR #90 で 18km → 25km に引き上げ:
// - WASM CSR mode で memory 主因のボトルネックに移行
// - 25km は corridor ~35 tiles / CSR ~110MB / settled ~150k で 128MB 内
// - 25km 超は frontend 側で midpoint 分割 (灰色直線 + waypoint 挿入) で対応
const MAX_STRAIGHT_LINE_METERS = 25000;
